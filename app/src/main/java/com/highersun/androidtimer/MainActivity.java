...
//                }
                    ...
                    if (millisecond == 999) {
                        ...
                        if (second == 59) {
                            ...
                            if (minute == 59) {
                                //天
                                if(hour == 24){
                                    // day++ ; hour = 0 ;   millisecond = 0;  second = 0;    minute = 0;
                                }else{
                                hour++;
                                millisecond = 0;
                                second = 0;
    ...
    public void setOriginTime(int setDay , int setHour, int setMinute, int setSecond, int setMilliSecond) {
        hour = setHour;
        minute = setMinute;
        second = setSecond;
